...
{
 $query = "SELECT * FROM `events` ORDER BY RAND() LIMIT 5";
            ...
            <label for="menu__active" class="menu__active">
              ...
              <div class="menu__arrow menu__arrow--top">
                ...
                $con=mysqli_connect($dbhost, $dbuser, $dbpass, $db);
                  ...
                  $id = $_GET["id"];
                  $read_news = "SELECT * FROM `events` WHERE id = '$id' ";
            ...
            <div class="news-cont">
                <div class="left-nc">
                    ...
                    <div class="leftnp">
                        ...
                        $con=mysqli_connect($dbhost, $dbuser, $dbpass, $db);
                        $r = 0;
                        $s = mysqli_query($con, "SELECT *, DATE_FORMAT(date_posted, '%c/%e/%Y') AS date FROM `events` 
                                                ORDER BY RAND() LIMIT 1;");
                        while($row = mysqli_fetch_array($s)){
                            echo 
                            '<a href="read-post.php?id='.$row["id"].'" class="prvb">
                                <h5>Previous</h5>
                                <h3>'.$row["title"].'</h3>';
                ...
                <div class="right-nc">
                    ...
                    while($row = mysqli_fetch_array($s)){
                        echo 
                        '<a href="read-post.php?id='.$row["id"].'" class="sidecolref">
                            <div class="sidecol">
