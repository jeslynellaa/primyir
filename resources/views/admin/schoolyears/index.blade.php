...
@section('content')
        ...
        <div class="well">
            ...
            <div class="well_top" style="align-items:center">
                ...
                <div class="functions_wrap">
                    <button type="button" class="list_function btn" data-toggle="modal" data-target="#schoolyearAdd">
                        Add New School Year
                    </button>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <div class="col-md-6 col-sm-6 offset-md-5">
                                    <button type="button" class="btn btn-success set_current">Set as Current SY</button>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).on('click', '.set_current', function(e) {
                e.preventDefault();
                var sy_id = $('#schoolyear_id').val();
                console.log(sy_id)
                ...
                $.ajax({
                    type: "PUT",
                    url: "/admin/schoolyears/"+sy_id+"/set",
                    dataType: "json",
                    success: function(response) {
                        //console.log(response);
                        if(response.status == 400){
                            ...
                            alert("Successfully set this school year as current!");
                            location.reload();
                        }
                    }
                });
