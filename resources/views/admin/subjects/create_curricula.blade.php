    ...
    <div class="wrapper">
        <div class="form_wrap">
            <div class="form_1 data_info">
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/curriculum">
                        @csrf
                        
                        <div class="form_item">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Curriculum Name') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class=" wow form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Enter Curriculum Name" autofocus>
                                @error('name')
                        ...
                        <div class="form_item">
                            ...
                            <div class="col-md-6">
                                <input id="acronym" type="text" class=" wow form-control @error('acronym') is-invalid @enderror" name="acronym" value="{{ old('acronym') }}" required autocomplete="acronym" placeholder="Enter Curriculum Acronym" autofocus>
                                @error('acronym')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
