        ...
        <div class="well">
            <div class="well_top" style="align-items:center">
                ...
                <div class="functions_wrap">
                    <a class="list_function" href="/admin/reports/sf9/{{$schoolyear->id}}/{{$section->id}}/generate">Generate</a>
                    ...
                    <tbody>
                        @foreach($studentSY as $student)
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a class="list_function" href="/admin/reports/sf9/{{$student->id}}/generate">Generate</a>
                                    <a href="/admin/reports/sf9/create-update/{{$student->id}}">Create or Edit </a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
