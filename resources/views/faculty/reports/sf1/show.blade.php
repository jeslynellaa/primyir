        ...
        <div class="well">
            <div class="well_top" style="align-items:center">
                ...
                <div class="functions_wrap">
                    <a class="list_function" href="/faculty/reports"><span class="icon"><ion-icon name="arrow-back-sharp"></ion-icon></span>Back</a>
                    <a class="list_function" href="/admin/reports/sf1/{{$schoolyear->id}}/{{$section->id}}/generate">Generate</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach($students as $student)
                            <tr>
                                ...
                                <td>{{ $student->name }}</td>
                                <td><a href="/faculty/reports/sf1/create-update/{{$student->studentsy}}">Create or Edit</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
